...
<c:set var="from" scope="session">
    <fmt:bundle basename='resources.config'><fmt:message key='path.page.admin.home' /></fmt:bundle>
</c:set>
...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="${context}/css/plugins/morris.css" rel="stylesheet">
...
<script src="${context}/js/plugins/morris/raphael.min.js"></script>
<script src="${context}/js/plugins/morris/morris.min.js"></script>
<script src="${context}/js/plugins/morris/morris-data.js"></script>
