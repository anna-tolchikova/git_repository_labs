...
<html>
    <head>
        ...
        <title><fmt:message key='admin.req.title' /></title>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message key="admin.req.h1.pageheader"/></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-primary" id="allRequestsPanel">
                            <div class="panel-heading">
                                ...
                                <b><fmt:message key="admin.req.table.title"/></b>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="allRequestsTable">
                                        ...
                                        <tr>
                                            <th></th>
                                            <th><fmt:message key="admin.req.table.th.status"/></th>
                                            <th><fmt:message key="admin.req.table.th.name"/></th>
                                            <th><fmt:message key="admin.req.table.th.model"/></th>
                                            <th><fmt:message key="admin.req.table.th.rentalDate"/></th>
                                            <th><fmt:message key="admin.req.table.th.rentalPeriod"/></th>
                                            <th><fmt:message key="admin.req.table.th.returndate"/></th>
                                            <th><fmt:message key="admin.req.table.th.repaircost"/></th>
                                            <th></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td  class="center">
                                                    <a style="display: inline-block; height:100%;width:100%; text-align:center;"
                                                       href="<fmt:bundle basename='resources.routing'><fmt:message key='path.page.admin.application'/></fmt:bundle>?id=${requestCl.clientRequest.id}">
                                                        <input class="btn btn-outline btn-primary btn-xs" type="button" value="<fmt:message key='admin.req.table.show'/>" />
                                                    </a>
                                                </td>
                                            </tr>
                                        </c:forEach>
