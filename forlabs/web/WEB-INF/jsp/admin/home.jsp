                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="newApplicationsTable">
                                        <thead>
                                            <tr>
                                                <th></th>
                                        ...
                                        <tbody>
                                            <c:forEach var="requestCl" items="${newRequests}">
                                                <tr>
                                                    ...
                                                    <td><fmt:formatDate value='${requestCl.rentalDate}' type='both' pattern='dd.MM.y, KK:mm:ss'/></td>
                                                    <td  class="center"><c:out value="${requestCl.period}"/></td>
                                                    <td  class="center">
                                                        <a style="display: inline-block; height:100%;width:100%; text-align:center;" href="<fmt:bundle basename='resources.routing'><fmt:message key='path.page.admin.application'/></fmt:bundle>?id=${requestCl.id}">
                                                            <input class="btn btn-outline btn-primary btn-xs" type="button" value="<fmt:message key='admin.home.table.newreq.show'/>" />
                                                        </a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
